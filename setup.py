...
setuptools.setup(
    ...
    version=__version__,
    license='GPL 3.0',
    description='Module provides base class for generic serialization/deserialiation of derived classes with elementaty type checking.',
    long_description=long_description,
    long_description_content_type="text/markdown",
    author='Jan Brezina',
    author_email='jan.brezina@tul.cz',    
    url='https://github.com/geomop/jsondata',
